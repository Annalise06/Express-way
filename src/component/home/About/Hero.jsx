      ...
      <section>
        <div className="relative w-full h-[40vh] lg:h-[60vh] lg:w-full object-contain">
          ...
          <div className="absolute bg-black/60 top-0 w-full h-full text-white pt-28 lg:pt-36 px-5 lg:px-28 lg:flex lg:justify-between font-cabin">
            <div>
              <p className="text-4xl lg:text-6xl font-semibold">About Us</p>
            </div>
          ...
          <div className="lg:mx-5 lg:w-[65%] pt-5 lg:pt-0">
            <div className="lg:w-[87%u]">
              ...
              <h1 className="text-xl lg:py-3 py-2 lg:text-[2rem] lg:leading-[2.8rem] font-bold tracking-wider text-[#161b5cda]">
                Reliable and express logistics and transport solutions that does
                not waste your time
              </h1>
            </div>
            <div>
              <p className="text-gray-500 text-sm leading-7 tracking-wider pb-9 lg:pt-3 pt-1">
                Fly Courier Logistic Services offers a host of logistic
                management services and supply chain solutions. We provide
                innovative solutions with the best people, processes, and
                technology. With over 60 years of providing world class service
                to their customers on the asset side, a need to provide a one
                stop shop for a” true customer service logistic solution” was
